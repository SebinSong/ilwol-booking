              ...
              <div className='home-flex-container'>
                ...
                <div className='intro-details pt-20'>
                  ...
                  <u1 className='intro-list mb-50'>
                    ...
                    <li className='intro-list-item'>하관 / 낙서 / 주역 / 명리학 / 기문둔갑을 천상에서 공부하신 신의 영매시며, 사심없이 진리와 이치에 충실한 제자이십니다.</li>
                  </u1>
                  ...
                  <div className='youtube-player-container'>
                    <iframe width='560' height='291'
                      title='Youtube video player'
                      frameborder="0"
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                      src="https://www.youtube-nocookie.com/embed/aGHIsmhuPn8"
                      allowFullScreen>
                    </iframe>
                  </div>
                </div>
